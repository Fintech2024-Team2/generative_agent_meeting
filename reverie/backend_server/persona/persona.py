...
class Persona: 
  ...
  def receive_announcement(self, announcement):
    """
    Receives an announcement and adds it to the persona's memory.
    ...
    OUTPUT
      None
    """
    self.scratch.add_thought(f"I received an announcement: {announcement}")
    self.a_mem.add_memory(self.scratch.get_current_time(), f"Announcement: {announcement}", 'announcement')
